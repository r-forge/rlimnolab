...
#' @details Functions \code{arrangeStateWise}  and \code{arrangeLayerWise} rearrange 
#'  state vectors from layer wise (ABCABCABC) to state wise (AAABBBCCC) and vice versa, 
#'  function \code{layers2vector} creates a state vector from a 
#'  matrix (layers x variables).
