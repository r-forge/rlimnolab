...
\setlength{\mathindent}{0cm}
 ...
 \author{The SALMO Developer Group\\ Technische Universit\"at Dresden\\ Institut f\"ur Hydrobiologie}
\title{Parameters and Equations of the Lake Model SALMO}
%\VignetteIndexEntry{Parameters and Equations of the Lake Model SALMO}

\begin{document}

\section*{Constant model parameters}
...
\section*{Internal variables of the model}
...
\begin{longtable} {l p{13cm}}
 ...
 $sumxpf$ & Summe der Zustände $x_i$ multipliziert mit $pf_i$\\
...
\begin{align*}
16.10 \hspace{0.5cm} seza = (neuer Parameter) \cdot \exp(0.08
